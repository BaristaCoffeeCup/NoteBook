package com.example.notebook.CS;
...
public class CSFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                AllTypeItems = mainViewModel.getItemWithPattern(Pattern,103);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.CS));
        collapsingToolbarLayout.setBackground(getResources().getDrawable(R.drawable.biankuang4));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = requireActivity().findViewById(R.id.RecycleViewCS);
        ...
        //绑定动态数据
        AllTypeItems = mainViewModel.getAllItemTypeLive(103);
        AllTypeItems.observe(getViewLifecycleOwner(), new Observer<List<item>>() {
            @Override
            public void onChanged(List<item> items) {
                int temp = myAdapter.getItemCount();
