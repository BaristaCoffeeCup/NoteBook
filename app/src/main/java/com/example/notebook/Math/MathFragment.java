package com.example.notebook.Math;
...
public class MathFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.Math));
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                AllTypeItems = mainViewModel.getItemWithPattern(Pattern,100);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = requireActivity().findViewById(R.id.RecycleViewMath);
        ...
        //绑定动态数据
        AllTypeItems = mainViewModel.getAllItemTypeLive(100);
        AllTypeItems.observe(getViewLifecycleOwner(), new Observer<List<item>>() {
            @Override
            public void onChanged(List<item> items) {
                int temp = myAdapter.getItemCount();
