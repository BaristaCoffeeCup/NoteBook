...
public class EnglishFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.English));
        collapsingToolbarLayout.setBackground(getResources().getDrawable(R.drawable.biankuang2));
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                AllTypeItems = mainViewModel.getItemWithPattern(Pattern,101);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = requireActivity().findViewById(R.id.RecycleViewEnglish);
        ...
        //绑定动态数据
        AllTypeItems = mainViewModel.getAllItemTypeLive(101);
        AllTypeItems.observe(getViewLifecycleOwner(), new Observer<List<item>>() {
            @Override
            public void onChanged(List<item> items) {
                int temp = myAdapter.getItemCount();
